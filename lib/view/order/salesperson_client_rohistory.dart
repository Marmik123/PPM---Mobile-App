...
class ReceivedClient extends StatefulWidget {
  String mobileNo;

  ReceivedClient({Key key, this.mobileNo}) : super(key: key);
  @override
  _ReceivedClientState createState() => _ReceivedClientState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              ParseLiveListWidget<ParseObject>(
                shrinkWrap: true,
                query: sCtrl.displayReceivedOrder(widget.mobileNo),
